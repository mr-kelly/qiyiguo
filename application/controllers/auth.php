...
class Auth extends KK_Controller
{
	...
	function register()
	{
		if ($this->tank_auth->is_logged_in()) {									// logged in
			...
			if ($use_username) {
				$this->form_validation->set_rules('username', 'Username', 'trim|required|min_length['.$this->config->item('username_min_length', 'tank_auth').']|max_length['.$this->config->item('username_max_length', 'tank_auth').']'); //|alpha_dash|xss_clean
			}
